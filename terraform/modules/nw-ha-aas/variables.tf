...
variable "target_size_a" {
  description = "The target number of running instances for the unmanaged instance group in zone a."
  default     = 1
}

variable "target_size_b" {
  description = "The target number of running instances for the unmanaged instance group in zone b."
  default     = 1
}
...
variable "alias_ip_inp_b" {
  default     = null
  description = "AAS alias input ip address for zone b"
}
