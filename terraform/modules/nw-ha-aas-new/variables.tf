...
variable "instance_name_a" {
  description = "Name of the instance in zone_a. Changing this will create a new instance."
}

variable "instance_name_b" {
  description = "Name of the instance in zone_b. Changing this will create a new instance."
}

variable "instance_ip_a" {
  description = "Static IP address for the instance in zone_a. Changing this will create a new instance."
}

variable "instance_ip_b" {
  description = "Static IP address for the instance in zone_b. Changing this will create a new instance."
}
...
variable "alias_ip_inp_a" {
  description = "Static alias IP address for the instance (optional) in zone_a."
  default     = null
}

variable "alias_ip_inp_b" {
  description = "Static alias IP address for the instance (optional) in zone_b."
  default     = null
}

variable "target_size_a" {
  description = "Desired number of running instances in the unmanaged instance group for zone_a. Required unless attached to an autoscaler."
  default     = 1
}

variable "target_size_b" {
  description = "Desired number of running instances in the unmanaged instance group for zone_b. Required unless attached to an autoscaler."
  default     = 1
}
