...
resource "google_compute_attached_disk" "log" {
  ...
  instance    = element(split("/", element(tolist(module.sap_hana_scaleup.instances_self_links), 0)), 10)
  device_name = "${element(split("/", element(tolist(module.sap_hana_scaleup.instances_self_links), 0)), 10)}-log"
  project     = var.project_id
  zone        = var.zone
...
resource "google_compute_attached_disk" "shared" {
  ...
  instance    = element(split("/", element(tolist(module.sap_hana_scaleup.instances_self_links), 0)), 10)
  device_name = "${element(split("/", element(tolist(module.sap_hana_scaleup.instances_self_links), 0)), 10)}-shared"
  project     = var.project_id
  zone        = var.zone
...
resource "google_compute_attached_disk" "usrsap" {
  ...
  instance    = element(split("/", element(tolist(module.sap_hana_scaleup.instances_self_links), 0)), 10)
  device_name = "${element(split("/", element(tolist(module.sap_hana_scaleup.instances_self_links), 0)), 10)}-usrsap"
  project     = var.project_id
  zone        = var.zone
...
resource "google_compute_attached_disk" "swap" {
  ...
  instance    = element(split("/", element(tolist(module.sap_hana_scaleup.instances_self_links), 0)), 10)
  device_name = "${element(split("/", element(tolist(module.sap_hana_scaleup.instances_self_links), 0)), 10)}-swap"
  project     = var.project_id
  zone        = var.zone
...
resource "google_compute_attached_disk" "addon_disks" {
  ...
  instance    = element(split("/", element(tolist(module.sap_hana_scaleup.instances_self_links), 0)), 10)
  device_name = "${element(split("/", element(tolist(module.sap_hana_scaleup.instances_self_links), 0)), 10)}-${var.hana_addon_disks.name[count.index]}"
  project     = var.project_id
  zone        = var.zone
