...
variable "sap_hana_instance_ip" {
  description = "A unique ip for the HANA instance. Changing this forces a new resource to be created."
}
...
variable "sap_nw_instance_ip" {
  description = "A unique ip for the netweaver instance. Changing this forces a new resource to be created."
}
