...
variable "sap_hana_zone" {
  description = "GCP zone for instance deployment."
  default     = "us-central1-a"
}

variable "sap_hana_master_node_name" {
  description = "Name of the HANA Master instance. Changing this will create a new instance."
}

variable "sap_hana_worker_node_names" {
  description = "Name of the HANA Worker instances. Changing this will create a new instance."
  type        = list(string)
  default     = []
}

variable "sap_hana_master_instance_ip" {
  description = "Static IP address for the HANA Master instance. Changing this will create a new instance."
}

variable "sap_hana_worker_instance_ips" {
  description = "Static IP address for the HANA Worker instances. Changing this will create a new instance."
  type        = list(string)
  default     = []
}
...
variable "sap_hana_usrsap_disk_type" {
