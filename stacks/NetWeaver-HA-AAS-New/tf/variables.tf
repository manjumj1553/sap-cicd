...
variable "sap_nw_aas_region" {
  description = "GCP region for instance deployment."
  default     = "us-central1"
}

variable "sap_nw_aas_zone_a" {
  description = "GCP zone_a for instance deployment."
  default     = "us-central1-a"
}

variable "sap_nw_aas_zone_b" {
  description = "GCP zone_b for instance deployment."
  default     = "us-central1-b"
}

variable "sap_nw_aas_instance_name_a" {
  description = "Name of the NetWeaver instance in zone_a. Changing this will create a new instance."
}

variable "sap_nw_aas_instance_name_b" {
  description = "Name of the NetWeaver instance in zone_b. Changing this will create a new instance."
}

variable "sap_nw_aas_instance_ip_a" {
  description = "Static IP address for the NetWeaver instance in zone_a. Changing this will create a new instance."
}

variable "sap_nw_aas_instance_ip_b" {
  description = "Static IP address for the NetWeaver instance in zone_b. Changing this will create a new instance."
}

variable "sap_nw_aas_instance_type" {
  description = "GCP instance/machine type for the NetWeaver instance."
  default     = "n1-highmem-32"
}

variable "sap_nw_aas_boot_disk_size" {
  description = "Size of the NetWeaver boot disk in GB."
  default     = 30
}

variable "sap_nw_aas_boot_disk_type" {
  description = "Type of the NetWeaver boot disk. Set to pd-standard (for PD HDD)."
  default     = "pd-ssd"
}

variable "sap_nw_aas_autodelete_boot_disk" {
  description = "Whether to auto-delete the boot disk when the instance is deleted."
}

variable "sap_nw_aas_usrsap_disk_size" {
  description = "Size of the NetWeaver usrsap disk in GB."
}

variable "sap_nw_aas_swap_disk_size" {
  description = "Size of the NetWeaver swap disk in GB."
}

variable "sap_nw_aas_usrsap_disk_type" {
  description = "Type of the NetWeaver usrsap disk."
}

variable "sap_nw_aas_swap_disk_type" {
  description = "Type of the NetWeaver swap disk."
}

variable "sap_nw_aas_service_account_email" {
  description = "Email address of the service account to attach to the NetWeaver instance."
}

variable "sap_nw_aas_network_tags" {
  description = "List of network tags for the NetWeaver instance."
  type        = list(string)
  default     = []
}

variable "sap_nw_aas_pd_kms_key" {
...
variable "sap_nw_aas_create_instance_group" {
  description = "Whether to create the NetWeaver AAS instance group."
  type        = bool
  default     = false
}

variable "sap_nw_aas_instance_group_name" {
  description = "Name of the primary NetWeaver AAS instance group."
  default     = ""
}

variable "sap_nw_aas_alias_ip_a" {
  description = "Alias IP address for the NetWeaver AAS instance (optional) in zone_a."
  default     = ""
}

variable "sap_nw_aas_alias_ip_b" {
  description = "Alias IP address for the NetWeaver AAS instance (optional) in zone_b."
  default     = ""
}
